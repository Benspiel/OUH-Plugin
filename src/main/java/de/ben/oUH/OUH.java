...
public final class OUH extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        AdminMenu adminMenu = new AdminMenu(this); // ← AdminMenu hinzufügen
        ...
        // AdminMenu registriert sich selbst als Listener in seinem Konstruktor

        // Commands registrieren
        getCommand("spawn").setExecutor(spawn);
        getCommand("help").setExecutor(firstJoin);
        getCommand("pvp").setExecutor(pvp);
        getCommand("admin").setExecutor(adminMenu); // ← Command /admin hinzufügen
    }
